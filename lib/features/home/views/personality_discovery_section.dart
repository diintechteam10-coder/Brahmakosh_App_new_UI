...
class _PersonalityDiscoverySectionState
  ...
  final Map<String, List<Color>> _tabColors = {
    "Health": [Color(0xFFE8F5E9), Color(0xFFC8E6C9)],
    "Emotions": [Color(0xFFE3F2FD), Color(0xFFBBDEFB)],
    "Profession": [Color(0xFFF3E5F5), Color(0xFFE1BEE7)],
    "Luck": [Color(0xFFFFF8E1), Color(0xFFFFECB3)],
    "Personal Life": [Color(0xFFFCE4EC), Color(0xFFF8BBD0)],
    "Travel": [Color(0xFFFFF3E0), Color(0xFFFFCC80)],
  };
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            ...
            final panchang = homeController.panchangData;
            final prediction =
                panchang?.dailyNakshatraPrediction?.prediction;

            String content = "Data unavailable";
print("hiihello ${homeController.panchangData?.dailyNakshatraPrediction?.prediction}");
            if (prediction != null) {
              switch (_tabs[_selectedIndex]) {
                case "Health":
                  content = prediction.health ?? "No health insights today";
                  break;

                case "Emotions":
                  content = prediction.emotions ?? "No emotional insights";
                  break;

                case "Profession":
                  content = prediction.profession ?? "No career insights";
                  break;

                case "Luck":
                  content = prediction.luck ?? "Luck insights unavailable";
                  break;

                case "Personal Life":
                  content =
                      prediction.personalLife ?? "No personal life insights";
                  break;

                case "Travel":
                  content = prediction.travel ?? "No travel insights";
                  break;
              }
            }
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _tabColors[_tabs[_selectedIndex]]![0]
                        .withOpacity(0.4),
                    blurRadius: 10,
                    offset: const Offset(0, 4),
                  ),
