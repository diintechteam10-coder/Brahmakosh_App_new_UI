...
class MeditationSelectionViewV2 extends StatefulWidget {
  ...
  const MeditationSelectionViewV2({super.key, required this.meditationCategoryId});

  @override
  State<MeditationSelectionViewV2> createState() => _MeditationSelectionViewV2State();
}

class _MeditationSelectionViewV2State extends State<MeditationSelectionViewV2> {
  final MeditationConfigurationController controller = Get.put(MeditationConfigurationController());
  String? _expandedCategoryId;

  @override
  void initState() {
    super.initState();
    // Fetch configurations on init
    controller.fetchConfigurations(widget.meditationCategoryId);
  }
  ...
  String _getCleanTitle(String text) {
    ...
    // Only strip if first char is non-ASCII (i.e., an emoji/symbol)
  ...
  // UI Mapping for Category Styles
  final Map<String, _CategoryStyle> _categoryStyles = {
    'Guided': _CategoryStyle(icon: Icons.stars_rounded, color: const Color(0xFFFFB74D)),
    'Breathwork': _CategoryStyle(icon: Icons.air_rounded, color: const Color(0xFF4DB6AC)),
    'Sound': _CategoryStyle(icon: Icons.music_note_rounded, color: const Color(0xFFF06292)),
    'Visualization': _CategoryStyle(icon: Icons.nights_stay_rounded, color: const Color(0xFF64B5F6)),
    'Others': _CategoryStyle(icon: Icons.spa_rounded, color: const Color(0xFFD4AF37)),
  };

  _CategoryStyle _getStyle(String categoryName) {
    // Case-insensitive match or fallback to 'Others'
  ...
  void _showDurationPicker(SpiritualConfiguration track) {
    Get.generalDialog(
        ...
        return BackdropFilter(
          ...
          child: SlideTransition(
            ...
            child: Align(
              ...
              child: DurationSelectionSheet(track: track),
            ),
          ),
        );
      },
                    ...
                    Obx(() {
                      ...
                      return Column(
                        children: grouped.entries.map((entry) {
                          ...
                          if (_expandedCategoryId == null && grouped.isNotEmpty) {
                          ...
                          return _CategoryCard(
                            ...
                            onTrackTap: _showDurationPicker,
                          );
                        }).toList(),
                      );
                    }),
          ...
          children: [
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    track.title ?? "Untitled Meditation",
                    maxLines: 1,
...
class DurationSelectionSheet extends StatefulWidget {
  ...
  const DurationSelectionSheet({super.key, required this.track});
              ...
              RichText(
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      text: widget.track.title ?? "Meditation",
              ...
              GestureDetector(
                onTap: _isStarting
                    ...
                    : () async {
                        ...
                        try {
                          int duration = _isCustom
                              ? (int.tryParse(_customController.text) ?? 10)
                              : _selectedMins;

                          final repository = SpiritualRepository();
                          final clipsResponse = await repository.getClips(widget.track.sId!);
                          ...
                          if (clipsResponse != null &&
                            ...
                            Utils.showToast("Failed to load meditation clips");
                          }
                        } catch (e) {
      ...
      child: GestureDetector(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(14),
            border: Border.all(
              color: const Color(0xFFD4AF37).withOpacity(_isCustom ? 0 : 0.4),
              width: 1.5,
            ),
          ),
          child: Column(
...
// Data Models
// Data Models removed - using SpiritualConfiguration
